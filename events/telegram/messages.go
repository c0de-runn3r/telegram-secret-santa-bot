...
const (
	...
	msgSetNickname      = "Привіт. Прошу вибачення за незручності, проте для користування цим ботом потрбіно мати нікнейм. Це для зручності інших гравців. Тому встанови нікнейм до свого аккаунту в налаштуваннях та повертайся сюди знову 😊"
)
